    ...
    <div class="mb-12" style="display:flex; flex-direction:column;">
      ...
      >
        <div class="search-box2">
          <v-form class="form-group-fn8">
            <v-container>
              <!-- <v-row v-for="(item, i) in lists" :key="i"> -->
              <v-row>
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn8">Select Name:</p>
                  </div>
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn8">Select Email:</p>
                  </div>
                  <v-combobox
                    v-model="email"
                    :items="items"
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn8">Select Business Unit:</p>
                  </div>
                  <v-combobox
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn8">Select Department:</p>
                  </div>
                  <v-combobox
                    v-model="department"
                    :items="items"
                ...
                >
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn8">Select Job Title:</p>
                  </div>
                  <v-combobox
                    v-model="job_title"
                    :items="items"
...
export default {
  ...
  methods: {
    ...
    businessUnitChange() {
      const job = this.desserts.filter((list) => list.job_title !== "");
      console.log(job);

      if (job.length === this.desserts.length) {
        this.search_list.push(...job);
      }
