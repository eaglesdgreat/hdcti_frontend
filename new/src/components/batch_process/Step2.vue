    ...
    <div class="mb-12" style="display:flex; flex-direction:column;">
      ...
      >
        <div class="search-box1">
          <v-form class="form-group-fn7">
            <v-container>
              <!-- <v-row v-for="(item, i) in lists" :key="i"> -->
              <v-row>
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn7">Select Name:</p>
                  </div>
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn7">Select Email:</p>
                  </div>
                  <v-combobox
                    v-model="email"
                    :items="items"
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn7">Select Business Unit:</p>
                  </div>
                  <v-combobox
                ...
                <v-col v-if="search_list.length > 0" cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn7">Select Department:</p>
                  </div>
                  <v-combobox
                    v-model="department"
                    :items="items"
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Report To", value: "leave" },
        { text: "Location", value: "shift" },
      ],
      desserts: [
        {
          name: "Micheal",
      ...
      business_unit: '',
      department: '',
      items: ["Programming", "Design", "Vue", "Vuetify", "Stride", "ERP", "Peace"],
      search_list:[],
      batch_select: '',
      batch_process_lists: [],
    };
  ...
  methods: {
    ...
    businessUnitChange() {
      const department = this.desserts.filter(list => list.department !== "")
      console.log(department)

      if(department.length === this.desserts.length) {
        this.search_list.push(...department)
      }
    ...
    getProjects(url = "http://opsmanager.local/api/user") {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.batch_process_lists = data.data;
