              ...
              <v-row>
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn6">Select Name:</p>
                  </div>
                ...
                <v-col cols="12" sm="6" md="4" lg="4" xl="4">
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn6">Select Email:</p>
                  </div>
                  <v-combobox
                    v-model="email"
                    :items="items"
                ...
                >
                  <div style="display:flex; justify-content:flex-start;">
                    <p class="style-fn6">Select Business Unit:</p>
                  </div>
                  <v-combobox
...
export default {
  ...
  data() {
    return {
      ...
      dialog: false,
      search: "",
      select: ["Programming", "Design", "Vue", "Vuetify"],
      selected: [],
      headers: [
        {
          text: "FirstName",
  ...
  methods: {
    ...
    businessUnitChange() {
      const business = this.desserts.filter((list) => list.unit !== "");
      console.log(business);

      if (business.length === this.desserts.length) {
        this.search_list.push(...business);
      }
